...
def create_UASpeech_custom_v2():
        ...
        word_file = '/DATA/nina/UASPEECH_SAGI/transcription_lut.csv'
        wordlist = []
        ...
        source_dir = '/DATA/nina/UASPEECH_SAGI/audio'
        results = {}
        ...
        target_dir = 'corpora/UASPEECH_Custom_3/audio'
        for speaker in results:
...
def cut_vad(c, nrg):
        ...
        """
        root_dir = 'corpora/UASPEECH_Custom_3/audio'
...
def inference():
        ...
        weights = 'run-multilingual/645000-G.ckpt'
        spk_emb_dim = 9810
        ...
        audio_dir = 'corpora/UASPEECH_Custom_3/audio'
        meta_dir = 'corpora/UASPEECH_Custom_3/inference'
...
def scatter_plot_regression():
        ...
        meta = 'reference_4'    # meta_0, meta_1, meta_2, meta_3 - and for all of then '_swapped'

        intelligibility = {} 
        with open('corpora/' + version + '/intelligibility.csv', mode='r') as handle:
                reader = csv.reader(handle)
                intelligibility = {rows[0]:rows[1] for rows in reader}

        meta_dir = 'corpora/' + version + '/' + meta + '/pathological'
        path_speaker_codes = {}
        ...
        meta_dir = 'corpora/' + version + '/' + meta + '/control'
...
def dtw_diff_condense():
        ...
        meta_ref_m = 'CM08'
        version = 'UASPEECH_Custom_3'
        root_dir = 'corpora/' + version + '/' + meta_dir

        ref_f, ref_m = dict(), dict()   # order: zc, zf, zr, mspec, mspecOutNoT
        #ref_dir = 'corpora/' + version + '/meta/reference'
        ref_dir = 'corpora/' + version + '/' + meta_dir + '/reference'
        ...
        ref_path_f = 'corpora/' + version + '/' + meta_dir + '/reference/' + meta_ref_f
        ref_path_m = 'corpora/' + version + '/' + meta_dir + '/reference/' + meta_ref_m
